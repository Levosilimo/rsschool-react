        ...
        <div className="footer-block">
          <div className="footer-creator">
            ...
            <ul className="dev-list">
              {DEVELOPERS.map((devData) => (
                <a
                  className="footer-link"
                  href={devData.linkPath}
                  rel="noopener noreferrer"
                  target="_blank"
                  key={devData.name}
                >
                  <span className="footer-link-name">{devData.name}</span>
                  <svg
